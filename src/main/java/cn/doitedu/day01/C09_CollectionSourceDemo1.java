 ...
 */
public class C09_CollectionSourceDemo1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<Integer> nums = env.fromCollection(lst);

        System.out.println("fromCollection 得到的DataStream的并行度：" + nums.getParallelism());
